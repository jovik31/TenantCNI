...
import (
	...
	scheme "github.com/jovik31/controller/pkg/client/clientset/versioned/scheme"
...
type TenantInterface interface {
	...
	Apply(ctx context.Context, tenant *jovik31devv1alpha1.TenantApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Tenant, err error)
	TenantExpansion
}
...
func newTenants(c *Jovik31V1alpha1Client, namespace string) *tenants {
	return &tenants{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tenants) Apply(ctx context.Context, tenant *jovik31devv1alpha1.TenantApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Tenant, err error) {
	if tenant == nil {
